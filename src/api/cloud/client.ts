...
enum Api {
  CLIENT = '/system/oauthClientDetails',
  checkClientId = '/system/oauthClientDetails/checkClientId',
}
...
export const checkClientId = (params: any) =>
  defHttpWithTransform.get<any>({ url: Api.checkClientId, params }, { errorMessageMode: 'none' });
